...
#we assign this empty variable in middleware(request_object.py) and access in below function get_total_by_vendor
request_object = ''
...
class Order(models.Model):
    ...
    vendors = models.ManyToManyField(Vendor, blank=True)#an order can belong to many venders
    ...
    def name(self):
     ...
     #an order can belong to many venders, so we print all venders in database
